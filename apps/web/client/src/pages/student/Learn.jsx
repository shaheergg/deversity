        ...
        <div className="flex flex-row flex-wrap items-start gap-5 p-6">
          ...
          <div className="right-0 border-2 border-gray-200 rounded-full">
            <div className="p-3 text-lg font-semibold">
              Daily Xp{" "}
              <span className="px-2 py-1 text-sm text-white rounded-full bg-slate-800">
                0 Xp
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className={`${
              category === "Other Courses"
                ? "border-b-secondary h-full font-semibold border-b-2"
                : ""
            } cursor-pointer  py-2`}
          >
            Other Courses
