...
const Course = () => {
  ...
  return (
    <>
      <div className="sticky top-0 flex items-center justify-center gap-8 px-4 py-3 bg-white border-b shadow">
        ...
        <div
          onClick={openModal}
          className="flex items-center justify-center text-lg font-semibold cursor-pointer font-grotesk"
        >
          <Link to="/student/dashboard" className="px-2 mx-2 border-r-2">
            <svg
          ...
          <div
            onClick={openModal}
            className="px-3 py-1 border-2 border-gray-300  hover:bg-slate-700 hover:text-white rounded-xl"
          >
            Course Outline
          </div>
          <Link to="/student/dashboard" className="px-2 mx-2 border-l-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="24"
      ...
      <div className="flex flex-col w-10/12 gap-2 p-10 m-auto font-grotesk">
        <div>
          <h1 className="text-3xl font-bold ">{course.title}</h1>
        </div>
        <div className="flex flex-row justify-between text-sm">
          <div>Read time : 3 hours | Completion time : 10 hours</div>
          <div className="">Educator : John Doe</div>
        </div>
